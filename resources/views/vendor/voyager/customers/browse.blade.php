...
{{--                    <div class="row datetimepicker id=daterange datepicker">--}}
{{--                        <form action="{{route("voyager.customers.index")}}">--}}
{{--                            <div class="col-md-2">--}}
{{--                                <input type="text" name="from_date" id="from_date" class="form-control datepicker" placeholder="From Date"  />--}}
{{--                            </div>--}}
{{--                            <div class="col-md-2">--}}
...
{{--                                <button type="button"  onclick="window.location='{{ route("voyager.customers.index") }}'" name="refresh" id="refresh" class="btn btn-primary btn-sm">Refresh</button>--}}
{{--                            </div>--}}
{{--                        </form>--}}
{{--                    </div>--}}
                    @if ($isServerSide)
