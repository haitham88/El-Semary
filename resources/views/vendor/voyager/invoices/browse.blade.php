...
<div class="page-content browse container-fluid">
    ...
    <div class="row datetimepicker id=daterange datepicker">
        <form action="{{route("voyager.invoices.index")}}">
            <div class="col-md-2">
                <input type="text" name="from_date" id="from_date" class="form-control datepicker" placeholder="From Date"  />
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2" id="filterform">
                ...
                <button type="button"  onclick="window.location='{{ route("voyager.invoices.index") }}'" name="refresh" id="refresh" class="btn btn-primary btn-sm">Refresh</button>
            </div>
        </form>
    </div>
    <div class="row">
