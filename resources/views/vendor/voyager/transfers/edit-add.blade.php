...
@section('javascript')
    <script>
        ...
        $('document').ready(function () {
            var myForm = document.getElementById("form22");
            // for (var i = 0; i < myForm.elements.length; i++) {
                var fromEmp = myForm.elements[1];
                var toEmp = myForm.elements[2];
                var money = myForm.elements[3];
            money.onchange = function() {
console.log("asfadsfasds")
            };
