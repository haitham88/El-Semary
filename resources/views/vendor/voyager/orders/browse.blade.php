...
{{--        <br />--}}
{{--        <br />--}}
{{--        <div class="row datetimepicker id=daterange datepicker">--}}
{{--            <div class="col-md-4">--}}
...
<div class="page-content browse container-fluid">
    ...
    <div class="row-6">
        <form action="{{route("voyager.orders.index")}}">
            ...
            <div class="col-md-2" id="filterform" >
                <input type="submit" value="Filter" class="btn btn-primary btn-sm" />
                <button type="button"  onclick="window.location='{{ route("voyager.orders.index") }}'" name="refresh" id="refresh" class="btn btn-primary btn-sm">Refresh</button>
            </div>
        </form>
    </div>
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table id="dataTable" class="table table-hover">
                            ...
                            @foreach($dataTypeContent as $data)
                                <tr class='clickable-row' data-href='{{route("voyager.items.index", ['rowId' => $data->serial_number])}}' >
                                    @if($showCheckboxColumn)
                                        <td>
...
{{--                    const formattedDate1 = d.getFullYear() + '-' + ("0" + (d.getMonth() + 1)).slice(-2) + '-' + ("0" + d.getDate()).slice(-2)--}}
...
{{--                    load_data(formattedDate1, formattedDate2);--}}
{{--                }--}}
{{--                else--}}
{{--                {--}}
...
{{--             console.log("haithammamamfmamdasf")--}}
